...
conn = sqlite3.connect('/mnt/workspace/bs_challenge/tcdata/bs_challenge_financial_14b_dataset/dataset/博金杯比赛数据.db')
cs = conn.cursor()
new_question_file_dir = '/mnt/workspace/bs_challenge/app/intermediate/question_SQL_V6.csv'
new_question_file = pd.read_csv(new_question_file_dir,delimiter = ",",header = 0)
g = open('/mnt/workspace/bs_challenge/app/intermediate/question_SQL_V6_exed.csv', 'w', newline='', encoding = 'utf-8-sig') 

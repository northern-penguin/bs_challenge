...
new_question_file_dir = '/mnt/workspace/bs_challenge/app/intermediate/A01_question_classify.csv'
new_question_file = pd.read_csv(new_question_file_dir,delimiter = ",",header = 0)
company_file_dir = '/mnt/workspace/bs_challenge/app/files/AF0_pdf_to_company.csv'
...
g = open('/mnt/workspace/bs_challenge/app/intermediate/A02_question_classify_entity.csv', 'w', newline='', encoding = 'utf-8-sig') 

...
new_question_file_dir = '/mnt/workspace/bs_challenge/app/intermediate/question_csv.csv'
...
g = open('/mnt/workspace/bs_challenge/app/intermediate/A01_question_classify.csv', 'w', newline='', encoding = 'utf-8-sig') 

...
pattern1 = r'\d{8}'
data_file_dir = '/mnt/workspace/bs_challenge/app/intermediate/question_SQL_V6_exed.csv'
data_file = pd.read_csv(data_file_dir,delimiter = ",",header = 0)

data_file2_dir = '/mnt/workspace/bs_challenge/app/intermediate/A01_question_classify.csv'
...
g = open('/mnt/workspace/bs_challenge/app/intermediate/FA_V5_SQL.csv', 'w', newline='', encoding = 'utf-8-sig') 

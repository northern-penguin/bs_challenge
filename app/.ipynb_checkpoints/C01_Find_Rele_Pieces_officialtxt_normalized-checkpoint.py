...
normalized_dir = '/mnt/workspace/bs_challenge/tcdata/data/normalized_ot.csv'
...
pdf_csv_file_dir = '/mnt/workspace/bs_challenge/tcdata/data/txt2csv_normalized'
...
g = open('/mnt/workspace/bs_challenge/app/intermediate/AB01_question_with_related_text_ot_normalized.csv', 'w', newline='', encoding = 'utf-8-sig') 

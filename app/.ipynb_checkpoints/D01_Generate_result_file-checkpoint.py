...
import json
import pandas as pd
csv_file_1_dir = "/mnt/workspace/bs_challenge/app/intermediate/FA_V5_SQL.csv"
csv_file_1 = pd.read_csv(csv_file_1_dir,delimiter = ",",header = 0)
csv_file_2_dir = "/mnt/workspace/bs_challenge/app/intermediate/FA_V5_Text_cap4_4_nt.csv"
...
with open('/mnt/workspace/bs_challenge/app/submit_result.jsonl',mode = 'w', encoding = 'utf-8') as f:
    for cyc in range(1000):

...
db0 = SQLDatabase.from_uri("sqlite:////mnt/workspace/bs_challenge/tcdata/bs_challenge_financial_14b_dataset/dataset/博金杯比赛数据.db", sample_rows_in_table_info=0)
dbd0 = db0.table_info

db2 = SQLDatabase.from_uri("sqlite:////mnt/workspace/bs_challenge/tcdata/bs_challenge_financial_14b_dataset/dataset/博金杯比赛数据.db", sample_rows_in_table_info=2)
dbd2 = db2.table_info
...
question_csv_file_dir = "/mnt/workspace/bs_challenge/app/intermediate/A01_question_classify.csv"
...
SQL_examples_file_dir = "/mnt/workspace/bs_challenge/app/files/ICL_EXP.csv"
...
g = open('/mnt/workspace/bs_challenge/app/intermediate/question_SQL_V6.csv', 'w', newline='', encoding = 'utf-8-sig') 
